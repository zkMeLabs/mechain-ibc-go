...
func (suite *InterchainAccountsTestSuite) TestInitModule() {
	...
	chainID := "testchain"
	app := simapp.NewSimApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simapp.DefaultNodeHome, 5, simapp.MakeTestEncodingConfig(), simtestutil.EmptyAppOptions{}, baseapp.SetChainID(chainID))
